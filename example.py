...
if __name__ == "__main__":
    ...
    csv_url = ("D:\MLProjects\ZDatasets\WineQuality\WineQT.csv")
    try:
    ...
    print(test)
    # The predicted column is "Qwality" which is a scalar from [3, 9]
    train_x = train.drop(["Qwality"],axis=1)
    test_x = test.drop(["Qwality"],axis=1)
